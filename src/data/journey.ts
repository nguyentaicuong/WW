...
export const journeyDays: JourneyDay[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { time: '10:00 - 11:00', activity: 'Thủ tục Check-out.' },
      { time: '11:00 - 12:30', activity: 'Ăn trưa tại nhà hàng Con Sò.' },
      { time: '12:30', activity: 'Di chuyển về VCCI Tower - Kết thúc hành trình ý nghĩa.' }
    ]
  }
];
